...
public class RealSun : MonoBehaviour
{
    ...
    void Start()
    {
        double latitude = 24.77381182949321;
        double longitude = 121.04411794317863;
        Vector3 angles = new Vector3();
        SunPosition.CalculateSunPosition(DateTime.UtcNow, (double)latitude, (double)longitude, out double azi, out double alt);
